...
(function($) {
	...
	BootstrapTable.DEFAULTS = {
		...
		dataType: 'json',
		ajaxOptions: { async: true, timeout: 1200000 },
		...
		icons: {
			...
			detailOpen: 'iconfont icon-show',
			detailClose: 'iconfont icon-hide'
		},
	...
	BootstrapTable.prototype.htmlspecialchars = function(string) {
		var varcreateDiv = document.createElement("textarea");
	...
	BootstrapTable.prototype.initData = function(data, type) {
		for(var i in data) {
			for(var j in data[i]) {
				data[i][j] = this.htmlspecialchars(data[i][j]);
				//				data[i][j] = data[i][j];
			}
		}
		if(type === 'append') {
